...
ADB: дазвол WRITE_SECURE_SETTINGS
...
1. На аўтамабілі: дазвольце **захоп экрана** (кнопка ў дадатку; пасля кожнай перазагрузкі).
2. **Не** запускайце навігацыю BYD AMap — яна блакуе староннія перадачы.
3. Запусціце маршрут у Yandex і трымайце Yandex **на экране**.
