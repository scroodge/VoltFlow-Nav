...
**Language:** [Belarusian](../CLUSTER_PROTOCOL.md) · **English** · [Russian](CLUSTER_PROTOCOL.ru.md)
...
naviState 0/1), third-party broadcasts are **ignored** (AmapService.java:253). Our bridge only
...
| 21–28 | roundabout L/R/straight/U variants (RHT 21–24, LHT 25–28) | roundabout-with-direction |
...
showed only the arrow (blank name). Cyrillic must be **transliterated to Latin** before
