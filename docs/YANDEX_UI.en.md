...
**Language:** [Belarusian](../YANDEX_UI.md) · **English** · [Russian](YANDEX_UI.ru.md)
...
| **maneuver arrow** | `ru.yandex.yandexnavi:id/image_maneuverballoon_maneuver` | image, bounds ~84×84 | **NO text/desc — direction needs image classification** |
